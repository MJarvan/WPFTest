...
namespace WPFTest
{
    ...
    {
        private static NpoiExcelExportHelper exportHelper;

        public static NpoiExcelExportHelper _
        {
            get => exportHelper ?? (exportHelper = new NpoiExcelExportHelper());
            set => exportHelper = value;
        }
        ...
        /// <param name="isBold">字体加粗 (None = 0,Normal = 400，Bold = 700</param>
        ...
        /// <returns></returns>
        public HSSFCellStyle CreateStyle(HSSFWorkbook workbook,HorizontalAlignment hAlignment,VerticalAlignment vAlignment,short fontHeightInPoints,bool isAddBorder,bool isBold,string fontName = "宋体",bool isAddBorderColor = true,bool isItalic = false,bool isLineFeed = false,bool isAddCellBackground = false,FillPattern fillPattern = FillPattern.NoFill,short cellBackgroundColor = HSSFColor.Yellow.Index,short fontColor = HSSFColor.Black.Index,FontUnderlineType underlineStyle =
